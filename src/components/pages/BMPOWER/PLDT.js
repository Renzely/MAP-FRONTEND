...
import pldtlogo from "../../Images/Bmpower_Logo/BMP - PLDT.png";
...
export default function BmpowerHO() {
      ...
      try {
        ...
        const bmpowerAccounts = response.data.filter(
          (acc) =>
            ...
            acc.clientAssigned?.toUpperCase() === "PLDT TELESCOOP",
        );
  ...
  const getExportData = async () => {
    try {
      ...
      link.download = `MASTERLIST_PLDT_${

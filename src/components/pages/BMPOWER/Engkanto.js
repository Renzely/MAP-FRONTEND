...
import engkantologo from "../../Images/Bmpower_Logo/BMP - ENGKANTO.jpg";
...
export default function BmpowerHO() {
      ...
      try {
        ...
        const bmpowerAccounts = response.data.filter(
          (acc) =>
            ...
            acc.clientAssigned?.toUpperCase() === "ENGKANTO",
        );
  ...
  const getExportData = async () => {
    try {
      ...
      link.download = `MASTERLIST_ENGKANTO_${

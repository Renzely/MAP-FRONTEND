...
import mandomlogo from "../../Images/Bmpower_Logo/BMP - MANDOM.png";
...
export default function BmpowerHO() {
      ...
      try {
        ...
        const bmpowerAccounts = response.data.filter(
          (acc) =>
            ...
            acc.clientAssigned?.toUpperCase() === "MANDOM",
        );
  ...
  const getExportData = async () => {
    try {
      ...
      link.download = `MASTERLIST_ASIAN_STREAK_${
